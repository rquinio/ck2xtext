...
public class InternalCk2Lexer extends Lexer {
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalCk2.g:2871:21: ( '0' .. '9' )
            // InternalCk2.g:2871:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_BOOL() throws RecognitionException {
        try {
            int _type = RULE_BOOL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCk2.g:2873:11: ( ( 'yes' | 'no' ) )
            // InternalCk2.g:2873:13: ( 'yes' | 'no' )
            {
            // InternalCk2.g:2873:13: ( 'yes' | 'no' )
            int alt1=2;
    ...
    public final void mRULE_HEX() throws RecognitionException {
        try {
            int _type = RULE_HEX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCk2.g:2875:10: ( '0x' ( RULE_DIGIT | 'a' | 'b' | 'c' | 'd' | 'e' | 'f' )+ )
            // InternalCk2.g:2875:12: '0x' ( RULE_DIGIT | 'a' | 'b' | 'c' | 'd' | 'e' | 'f' )+
            {
            match("0x"); 

            // InternalCk2.g:2875:17: ( RULE_DIGIT | 'a' | 'b' | 'c' | 'd' | 'e' | 'f' )+
            int cnt2=0;
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCk2.g:2877:10: ( ( RULE_DIGIT )+ )
            // InternalCk2.g:2877:12: ( RULE_DIGIT )+
            {
            // InternalCk2.g:2877:12: ( RULE_DIGIT )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_NON_ASCII_CAP() throws RecognitionException {
        try {
            // InternalCk2.g:2879:29: ( ( '\\u00C0' | '\\u00C1' | '\\u00C2' | '\\u00C3' | '\\u00C4' | '\\u00C5' | '\\u00C6' | '\\u00C7' | '\\u00C8' | '\\u00C9' | '\\u00CA' | '\\u00CB' | '\\u00CC' | '\\u00CD' | '\\u00CE' | '\\u00CF' | '\\u00D0' | '\\u00D1' | '\\u00D2' | '\\u00D3' | '\\u00D4' | '\\u00D5' | '\\u00D6' | '\\u00D8' | '\\u0160' | '\\u00D9' | '\\u00DA' | '\\u00DB' | '\\u00DC' | '\\u00DD' | '\\u0178' | '\\u00DE' | '\\u00DF' | '\\u0152' ) )
            // InternalCk2.g:2879:31: ( '\\u00C0' | '\\u00C1' | '\\u00C2' | '\\u00C3' | '\\u00C4' | '\\u00C5' | '\\u00C6' | '\\u00C7' | '\\u00C8' | '\\u00C9' | '\\u00CA' | '\\u00CB' | '\\u00CC' | '\\u00CD' | '\\u00CE' | '\\u00CF' | '\\u00D0' | '\\u00D1' | '\\u00D2' | '\\u00D3' | '\\u00D4' | '\\u00D5' | '\\u00D6' | '\\u00D8' | '\\u0160' | '\\u00D9' | '\\u00DA' | '\\u00DB' | '\\u00DC' | '\\u00DD' | '\\u0178' | '\\u00DE' | '\\u00DF' | '\\u0152' )
            {
    ...
    public final void mRULE_NON_ASCII_LOW() throws RecognitionException {
        try {
            // InternalCk2.g:2881:29: ( ( '\\u00E0' | '\\u00E1' | '\\u00E2' | '\\u00E3' | '\\u00E4' | '\\u00E5' | '\\u00E6' | '\\u00E7' | '\\u00E8' | '\\u00E9' | '\\u00EA' | '\\u00EB' | '\\u00EC' | '\\u00ED' | '\\u00EE' | '\\u00EF' | '\\u00F0' | '\\u00F1' | '\\u00F2' | '\\u00F3' | '\\u00F4' | '\\u00F5' | '\\u00F6' | '\\u00F8' | '\\u0161' | '\\u00F9' | '\\u00FA' | '\\u00FB' | '\\u00FC' | '\\u00FD' | '\\u00FF' | '\\u017E' | '\\u00FE' | '\\u0153' ) )
            // InternalCk2.g:2881:31: ( '\\u00E0' | '\\u00E1' | '\\u00E2' | '\\u00E3' | '\\u00E4' | '\\u00E5' | '\\u00E6' | '\\u00E7' | '\\u00E8' | '\\u00E9' | '\\u00EA' | '\\u00EB' | '\\u00EC' | '\\u00ED' | '\\u00EE' | '\\u00EF' | '\\u00F0' | '\\u00F1' | '\\u00F2' | '\\u00F3' | '\\u00F4' | '\\u00F5' | '\\u00F6' | '\\u00F8' | '\\u0161' | '\\u00F9' | '\\u00FA' | '\\u00FB' | '\\u00FC' | '\\u00FD' | '\\u00FF' | '\\u017E' | '\\u00FE' | '\\u0153' )
            {
    ...
    public final void mRULE_ID_PART() throws RecognitionException {
        try {
            // InternalCk2.g:2883:23: ( ( 'a' .. 'z' | 'A' .. 'Z' | RULE_NON_ASCII_LOW | RULE_NON_ASCII_CAP | '<' ) )
            // InternalCk2.g:2883:25: ( 'a' .. 'z' | 'A' .. 'Z' | RULE_NON_ASCII_LOW | RULE_NON_ASCII_CAP | '<' )
            {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCk2.g:2885:9: ( ( '^' )? RULE_ID_PART ( RULE_ID_PART | RULE_DIGIT | '_' | '-' | '\\'' | '\\u2019' | ':' | '.' | '>' )* )
            // InternalCk2.g:2885:11: ( '^' )? RULE_ID_PART ( RULE_ID_PART | RULE_DIGIT | '_' | '-' | '\\'' | '\\u2019' | ':' | '.' | '>' )*
            {
            // InternalCk2.g:2885:11: ( '^' )?
            int alt4=2;
            ...
            mRULE_ID_PART(); 
            // InternalCk2.g:2885:29: ( RULE_ID_PART | RULE_DIGIT | '_' | '-' | '\\'' | '\\u2019' | ':' | '.' | '>' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCk2.g:2887:13: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalCk2.g:2887:15: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalCk2.g:2887:19: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
            loop6:
            do {
                int alt6=3;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCk2.g:2889:17: ( '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalCk2.g:2889:19: '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match('#'); 
            // InternalCk2.g:2889:23: (~ ( ( '\\n' | '\\r' ) ) )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCk2.g:2891:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalCk2.g:2891:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalCk2.g:2891:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt10=0;
            loop10:
    ...
    static final String[] DFA11_transitionS = {
            "\2\21\2\uffff\1\21\22\uffff\1\21\1\uffff\1\17\1\20\7\uffff\1\2\1\uffff\1\1\1\3\1\uffff\1\14\11\15\2\uffff\1\16\1\7\3\uffff\32\16\1\10\1\uffff\1\11\1\16\2\uffff\5\16\1\4\7\16\1\13\12\16\1\12\1\16\1\5\1\uffff\1\6\102\uffff\27\16\1\uffff\37\16\1\uffff\10\16\122\uffff\2\16\14\uffff\2\16\26\uffff\1\16\5\uffff\1\16",
            "",
            "",
            "",
